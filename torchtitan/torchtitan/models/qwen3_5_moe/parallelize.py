...
from torchtitan.distributed.compile import apply_compile_sparse as apply_compile
            ...
            layer_plan.update(
                {
                    ...
                    # forward stays DTensor (local_output_grad_placements=None).
                    "attn.in_proj_qkv": NoParallel(),
                    "attn.in_proj_z": NoParallel(),
                    "attn.in_proj_a": NoParallel(),
                    "attn.in_proj_b": NoParallel(),
                    "attn.out_proj": NoParallel(),
                    # Gated RMSNorm: weight as Replicate DTensor.
                    "attn.norm": NoParallel(),
                }
            )
        ...
        layer_plan.update(
            {
                ...
                "shared_gate": NoParallel(
                    ...
                    local_output_grad_placements=[Shard(1)],
                ),
